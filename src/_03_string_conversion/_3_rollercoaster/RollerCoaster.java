...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		...
		// Uncomment the line below...
			if (heightToRide >= 42) { 
				if (heightToRide >= 48) {
					JOptionPane.showMessageDialog(null, "You can ride without an adult");
				}
				else {
					JOptionPane.showMessageDialog(null, "You can ride, but only with an adult");
				}
			}
			else {
				JOptionPane.showMessageDialog(null, "You can not ride");
			}
